...
Removed (done — see the [audit](../docs/reviews/2026-07-10-post-implementation-audit.md) §1 and [follow-up review](../docs/reviews/2026-07-13-follow-up-review.md)): 1.1 coverage metric · 1.2 report correctness · 1.3 release execution · 2.1 dogfood · 2.2 example + README · 3.1 structured trace · 3.2 generated importers · 4.1 UX polish · 4.2 OSS hygiene. The U1 stale-flag time bomb found in the audit was fixed directly (report `--now`), not spec'd.
